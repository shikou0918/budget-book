...
export const transactionApi = {
  ...
  update: (id: number, data: CreateTransactionRequest) => api.put<Transaction>(`/transactions/${id}`, data),
...
export const budgetApi = {
  ...
  getByMonth: (year: number, month: number) => api.get<Budget[]>(`/budgets?year=${year}&month=${month}`),
