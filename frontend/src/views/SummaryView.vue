  ...
  <div class="summary">
    ...
    <div v-else-if="summary" class="summary-content">
      <div class="summary-grid">
        <div class="card summary-card">
          ...
          <div class="summary-stats">
            ...
            <div class="stat">
              ...
              <span class="stat-value" :class="{ income: summary.balance >= 0, expense: summary.balance < 0 }">
        ...
        <div class="card">
          <h3>カテゴリ別詳細</h3>
          <div v-if="categoryDetails.length === 0" class="no-data">
            データがありません
          </div>
          <div v-else>
            <table class="table">
              ...
              <tbody>
                <tr v-for="detail in categoryDetails" :key="detail.category_id">
                  ...
                  <td :class="{ income: detail.category_type === 'income', expense: detail.category_type === 'expense' }">
